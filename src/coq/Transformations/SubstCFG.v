...
Lemma interp_vir_model_user_bind: forall {R S} g l m (t: itree _ R) (k: R -> itree _ S) t',
    interp_vir_model_user [] (bind t k) g l m t' ->
    bind (interp_vir_model_user [] t g l m) (fun '(m,(l,(g,x))) => interp_vir_model_user [] (k x) g l m) t'.
Proof.
  intros.
  cbn in *.
