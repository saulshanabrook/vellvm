...
Module Type LLVM_INTERACTIONS (ADDR : MemoryAddress.ADDRESS).
  ...
  Definition instr_E := CallE +' ExternalCallE +' IntrinsicE +' exp_E.
  ...
  Definition instr_E_to_L0' : instr_E ~> L0' :=
    fun T e =>
      ...
      | inr1 (inr1 (inr1 (inl1 e))) => inr1 (inr1 (inr1 (inl1 e)))
      | inr1 (inr1 (inr1 (inr1 (inl1 e)))) => inr1 (inr1 (inr1 (inr1 (inl1 (inl1 e)))))
