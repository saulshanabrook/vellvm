...
Section ExpPure.
  ...
  Lemma expr_are_pure : forall (o : option dtyp) (e : exp dtyp),
      no_conv e ->
        pure ⟦ e at? o ⟧e3.
  Proof with trivial_cases.
    ...
    - go.
      ...
      inv H.
      apply (IHe1 (Some t) H2 g l m).
      intros (? & ? & ? & ?) (-> & -> & ->).
      go.
      eapply has_post_bind_strong.
      inv H.
      apply (IHe2 (Some t) H5 g l m).
      intro_pure.
      break_match_goal.
      + go.
    ...
    - go.
      eapply has_post_bind_strong.
      inv H.
      specialize (IHe1 (Some t) H2 g l m). apply IHe1.
      intro_pure.
      go.
      eapply has_post_bind_strong.
      inv H.
