...
Section Memory_Stack_Theory.
  ...
  Qed.
    ...
    Proof.
    Admitted. (* Currently admitted because we were missing some cases: annoying proof about the serialization of values that requires a lot of arithmetic at each integer size. Will be fixed soon. *)
